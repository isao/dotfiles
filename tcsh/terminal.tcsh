...
#set _promptvcs = 'git branch |& grep ^\* | cut -c3-33'   <- alias moved to ./git.tcsh as `gitbranch`

# set window title to host:path; set prompt to time+user+$VCS
sched +0:00 alias precmd 'set prompt="%{\033]0;%n@%m:%c03\007%}%T%n%{\033[34m%}`gitbranch`%{\033[0m%}%# "'
